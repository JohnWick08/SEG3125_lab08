...
const StepTwo = (props) => {
    ...
    if (lang==="English"){
        ...
        if (score >= 0 && score < 6){
            ...
            imageSource = '../images/level4_fr.jpg';
            ...
            imageSource = '../images/level5_fr.jpg';
